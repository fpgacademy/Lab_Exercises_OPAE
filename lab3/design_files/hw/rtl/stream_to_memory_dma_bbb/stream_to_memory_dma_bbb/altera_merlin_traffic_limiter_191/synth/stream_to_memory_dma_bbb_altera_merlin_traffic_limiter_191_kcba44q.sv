...
module stream_to_memory_dma_bbb_altera_merlin_traffic_limiter_191_kcba44q
#(
   parameter
      PKT_TRANS_POSTED           = 1,
      PKT_DEST_ID_H              = 0,
   ...
   generate
      if (REORDER) begin: fifo_dest_id_write_read_control_reorder_on
         ...
         for (j = 0;j < MAX_DEST_ID; j = j+1) begin : trans_sequence_per_fifo
            ...
            stream_to_memory_dma_bbb_altera_merlin_traffic_limiter_191_bbthvuy #(
                  .SYMBOLS_PER_BEAT   (1),
            ...
            //alt_hiconnect_sc_fifo # (
              stream_to_memory_dma_bbb_altera_merlin_traffic_limiter_191_oslblqy # (
                .IMPL                  ("reg"),
                .SYMBOLS_PER_BEAT      (1),   
